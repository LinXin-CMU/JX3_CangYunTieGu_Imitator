...
_recipe = namedtuple('recipe_data', ['index', 'slot', 'desc'])

recipe = {
    # 盾刀
    1863: _recipe(79, "atPhysicsCriticalPercent", "盾刀2%会心"),     # pushButton_{key}
    1864: _recipe(15, "atPhysicsCriticalPercent", "盾刀3%会心"),
    1865: _recipe(16, "atPhysicsCriticalPercent", "盾刀4%会心"),
    1860: _recipe(13, "atRecipeDamagePercent", "盾刀3%伤害"),
    1861: _recipe(17, "atRecipeDamagePercent", "盾刀4%伤害"),
    1862: _recipe(18, "atRecipeDamagePercent", "盾刀5%伤害"),
    1866: _recipe(14, "atSkillEventHandler", "盾刀第三段+5回怒"),
    # 盾压
    1856: _recipe(24, "atSkillEventHandler", "盾压-1s调息"),
    1857: _recipe(21, "atSkillEventHandler", "盾压-1s调息"),
    1854: _recipe(22, "atPhysicsCriticalPercent", "盾压3%会心"),
    1855: _recipe(19, "atPhysicsCriticalPercent", "盾压4%会心"),
    1852: _recipe(23, "atRecipeDamagePercent", "盾压4%伤害"),
    1853: _recipe(25, "atRecipeDamagePercent", "盾压5%伤害"),
    1858: _recipe(20, "atSkillEventHandler", "盾压5%触发"),
    1859: _recipe(26, "atSkillEventHandler", "盾压5%触发"),
    # 劫刀
    1833: _recipe(30, "atPhysicsCriticalPercent", "劫刀2%会心"),
    1834: _recipe(27, "atPhysicsCriticalPercent", "劫刀3%会心"),
    1835: _recipe(32, "atPhysicsCriticalPercent", "劫刀4%会心"),
    1830: _recipe(31, "atRecipeDamagePercent", "劫刀3%伤害"),
    1831: _recipe(33, "atRecipeDamagePercent", "劫刀4%伤害"),
    1832: _recipe(29, "atRecipeDamagePercent", "劫刀5%伤害"),
    1836: _recipe(28, "atSkillEventHandler", "劫刀-5耗怒"),
    # 斩刀
    1841: _recipe(37, "atPhysicsCriticalPercent", "斩刀2%会心"),
    1842: _recipe(34, "atPhysicsCriticalPercent", "斩刀3%会心"),
    1843: _recipe(39, "atPhysicsCriticalPercent", "斩刀4%会心"),
    1838: _recipe(38, "atRecipeDamagePercent", "斩刀3%伤害"),
    1839: _recipe(40, "atRecipeDamagePercent", "斩刀4%伤害"),
    1840: _recipe(36, "atRecipeDamagePercent", "斩刀5%伤害"),
    1844: _recipe(35, "atSkillEventHandler", "斩刀锁足"),
    1845: _recipe(41, "atSkillEventHandler", "斩刀解锁足减速"),
    # 绝刀
    1848: _recipe(44, "atPhysicsCriticalPercent", "绝刀3%会心"),
    1849: _recipe(47, "atPhysicsCriticalPercent", "绝刀4%会心"),
    1846: _recipe(45, "atRecipeDamagePercent", "绝刀4%伤害"),
    1847: _recipe(46, "atRecipeDamagePercent", "绝刀5%伤害"),
    1895: _recipe(48, "atSkillEventHandler", "绝刀-1s调息"),
    1896: _recipe(49, "atSkillEventHandler", "绝刀-2s调息"),
    1850: _recipe(42, "atSkillEventHandler", "绝刀-15耗怒"),
    # 盾飞
    1955: _recipe(50, "atPhysicsCriticalPercent", "盾飞2%会心"),
    1956: _recipe(52, "atPhysicsCriticalPercent", "盾飞3%会心"),
    1953: _recipe(51, "atRecipeDamagePercent", "盾飞3%伤害"),
    1954: _recipe(53, "atRecipeDamagePercent", "盾飞4%伤害"),
    1957: _recipe(43, "atSkillEventHandler", "盾飞+5s持续"),
    1958: _recipe(54, "atSkillEventHandler", "盾飞+5s持续"),
    # 盾舞
    1904: _recipe(55, "atPhysicsCriticalPercent", "盾舞3%会心"),
    1905: _recipe(57, "atPhysicsCriticalPercent", "盾舞4%会心"),
    1902: _recipe(58, "atRecipeDamagePercent", "盾舞4%伤害"),
    1903: _recipe(59, "atRecipeDamagePercent", "盾舞5%伤害"),
    1906: _recipe(61, "atSkillEventHandler", "盾舞+1尺范围"),
    1907: _recipe(60, "atSkillEventHandler", "盾舞+1尺范围"),
    1908: _recipe(56, "atSkillEventHandler", "盾舞+1s持续"),
    1909: _recipe(62, "atSkillEventHandler", "盾舞+2s持续"),
    # 盾墙
    1880: _recipe(67, "atSkillEventHandler", "盾墙-5s调息"),
    1881: _recipe(65, "atSkillEventHandler", "盾墙-5s调息"),
    1882: _recipe(69, "atSkillEventHandler", "盾墙-5s调息"),
    1885: _recipe(68, "atSkillEventHandler", "盾墙+5%移速"),
    1886: _recipe(63, "atSkillEventHandler", "盾墙+5%移速"),
    1887: _recipe(70, "atSkillEventHandler", "盾墙+5%移速"),
    1888: _recipe(66, "atSkillEventHandler", "盾墙+10%减伤"),
    1889: _recipe(64, "atSkillEventHandler", "盾墙+10%减伤"),
    # 血怒
    1870: _recipe(71, "atSkillEventHandler", "血怒+5回怒"),
    1871: _recipe(77, "atSkillEventHandler", "血怒+5回怒"),
    1872: _recipe(75, "atSkillEventHandler", "血怒+5回怒"),
    1867: _recipe(74, "atSkillEventHandler", "血怒+1s持续"),
    1868: _recipe(73, "atSkillEventHandler", "血怒+1s持续"),
    1869: _recipe(78, "atSkillEventHandler", "血怒+1s持续"),
    1873: _recipe(76, "atSkillEventHandler", "血怒2%回血"),
    1874: _recipe(72, "atSkillEventHandler", "血怒3%回血"),
}
